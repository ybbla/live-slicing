"""Pack all Volcengine ASR transcripts in <edit>/transcripts/ into one readable markdown.
...
the PRIMARY artifact the LLM reads to pick clips — it fits one
...
Usage:
    python -m liveslicing.pack_transcripts --edit-dir <edit_dir>
    python -m liveslicing.pack_transcripts --edit-dir <edit_dir> --silence-threshold 0.5
"""
