...
Walks <videos_dir> for common video extensions, runs Volcengine ASR (flash)
on each, writes transcripts to <videos_dir>/edit/transcripts/<name>.json.

Cached per-file: any source that already has a transcript is skipped.

Usage:
    python -m liveslicing.transcribe_batch <videos_dir>
    python -m liveslicing.transcribe_batch <videos_dir> --workers 4
"""
